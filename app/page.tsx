...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-white" style={{ fontFamily: "Verdana, Geneva, sans-serif" }}>
      ...
      <section className="relative w-full overflow-hidden m-0 p-0 pt-20 md:pt-24 bg-white">
        <div className="w-full m-0 p-0 px-4 sm:px-6 lg:px-8">
          <div className={`relative min-h-[70vh] sm:min-h-[80vh] md:min-h-screen flex transition-all duration-700 ease-in-out ${
            ...
            {isScrolled && (
            <div className="flex flex-col justify-center px-6 sm:px-8 lg:px-12 py-12 lg:py-20 bg-white w-full lg:w-1/2 transition-all duration-700 ease-in-out">
              <h1
            ...
            <div
              ...
              className={`relative h-[70vh] sm:h-[80vh] md:h-screen overflow-hidden rounded-3xl sm:rounded-[3rem] md:rounded-[4rem] transition-all duration-700 ease-in-out w-full lg:ml-auto ${isScrolled ? 'lg:w-1/2' : 'lg:w-full'}`}
            ...
            >
              ...
              {/* Content - Moves with video to right side, stays visible */}
              <div className="relative z-10 h-full flex items-center justify-center transition-all duration-700 ease-in-out">
