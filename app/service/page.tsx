...
export default function Page() {
  const categories = useMemo(
    () => [
      {
        id: 'graphic',
        title: '01. Graphic Work',
        items: [
          'Logo & Branding Design',
          'Posters, Banners & Flyers',
          'Visiting Card & Invitation Card',
          'Certificate & Bill Book',
          'Photo Editing & Retouching',
          'Book Design & Facebook Post Design',
        ],
      },
      {
        id: 'offset',
        title: '02. Offset Work',
        items: [
          'Bill Book Printing',
      ...
      },
      {
        ...
        items: [
          ...
          'Tag Printing',
          'Bookmark Printing',
          'Invitation & Wedding Card Printing',
        ],
      },
      {
        id: 'sublimation',
        title: '04. Sublimation Work',
        items: [
          'Mug Printing',
          'T-Shirt Printing',
